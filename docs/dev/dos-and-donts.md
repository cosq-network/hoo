...
- **Run tests** before committing: `cmake --build . --target hoo_tests && ./hoo_tests`.
- **Update mangle/demangle together** — they must stay symmetric.

## Don't

- **Don't modify generated parser files** (anything in `src/parser/ho_*.cpp/h`). Edit `.g4` and regenerate.
