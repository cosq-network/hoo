...
2. [SimpleASTBuilder](simple-ast-builder.md) — The parser-context traversal that converts parse trees to ASTs.
3. [HVMCodeGenerator](hvm-code-generator.md) — The AST-to-bytecode compiler (~6,700 lines).
4. [HOModule Binary Layout](ho-module.md) — The binary container format (24 section types, LE encoding).
...
8. [HVMJIT](hvm-jit.md) — The LLVM ORC-based JIT execution engine (~10,100 lines).
