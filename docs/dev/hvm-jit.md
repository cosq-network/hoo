...
| Tensor | 15+ (`new1`, `new2`, `new3`, `new`, `push_value`, `length`, `rank`, `element_type`, `dim`, `get_int64`, `get_double`, `add`, `sub`, `element_mul`, `element_div`, `matmul`, `eq`, `ne`, `lt`, `le`, `gt`, `ge`, `and`, `or`, `not`) | `hoo_tensor.h` |
