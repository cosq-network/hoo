...
- **Resolution 2026-08-09**: Removed the unreferenced `interpolatedString` grammar rule and deleted the unused/unimplemented AST builder helpers. Interpolation remains implemented through the primary string visitor's `${...}` scanner.
