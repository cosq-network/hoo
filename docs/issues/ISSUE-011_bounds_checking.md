...
- **Status**: **FIXED**
- **Priority**: **HIGH**
- **Audit 2026-06-21**: Verified array, tensor, `HashMap`, and `AnyArray` indexed access continue to route through runtime/helper calls that centralize bounds and null checks.
