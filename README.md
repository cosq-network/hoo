...
- [x] **Verification**: full preset test run passing (`1637 tests`, 0 failures, 2 disabled).
...
tests/         Exhaustive unit and integration test suites (1637 tests in the current preset run).
