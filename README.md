...
- [x] **Verification**: full preset test run passing (`2062 tests`, 2 disabled, 0 failures).
...
tests/         Exhaustive unit and integration test suites (2062 tests in the current preset run).
