...
- [x] **Verification**: full preset test run passing (`2064 tests`, 2 disabled, 0 failures).
...
tests/         Exhaustive unit and integration test suites (2064 tests in the current preset run).
