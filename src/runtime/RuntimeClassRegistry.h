...
#define RUNTIME_CLASSES \
    DEFINE_RUNTIME_CLASS(String, HooString, isPointerTy) \
        ...
        END_RUNTIME_OPERATORS \
    \
    DEFINE_RUNTIME_CLASS(Int64Array, HooInt64Array, isPointerTy) \
        BEGIN_RUNTIME_FUNCTIONS \
            /* Creation functions */ \
            RUNTIME_FUNCTION(new, HooInt64Array, LLVM_PTR, \
                (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(from_buffer, HooInt64Array, LLVM_PTR, \
                (const int64_t*, LLVM_PTR), (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(repeat, HooInt64Array, LLVM_PTR, \
                (int64_t, LLVM_I64), (int64_t, LLVM_I64)) \
            \
            /* Basic operations */ \
            RUNTIME_FUNCTION(length, int64_t, LLVM_I64, \
                (HooInt64Array, LLVM_PTR)) \
            RUNTIME_FUNCTION(get, int64_t, LLVM_I64, \
                (HooInt64Array, LLVM_PTR), (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(set, int64_t, LLVM_I64, \
                (HooInt64Array, LLVM_PTR), (int64_t, LLVM_I64), (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(push, int64_t, LLVM_I64, \
                (HooInt64Array, LLVM_PTR), (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(pop, int64_t, LLVM_I64, \
                (HooInt64Array, LLVM_PTR)) \
            RUNTIME_FUNCTION(clear, void, LLVM_VOID, \
                (HooInt64Array, LLVM_PTR)) \
            RUNTIME_FUNCTION(contains, int64_t, LLVM_I64, \
                (HooInt64Array, LLVM_PTR), (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(index_of, int64_t, LLVM_I64, \
                (HooInt64Array, LLVM_PTR), (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(concat, HooInt64Array, LLVM_PTR, \
                (HooInt64Array, LLVM_PTR), (HooInt64Array, LLVM_PTR)) \
            RUNTIME_FUNCTION(slice, HooInt64Array, LLVM_PTR, \
                (HooInt64Array, LLVM_PTR), (int64_t, LLVM_I64), (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(clone, HooInt64Array, LLVM_PTR, \
                (HooInt64Array, LLVM_PTR)) \
            \
            /* Reference counting */ \
            RUNTIME_FUNCTION(retain, HooInt64Array, LLVM_PTR, \
                (HooInt64Array, LLVM_PTR)) \
            RUNTIME_FUNCTION(release, void, LLVM_VOID, \
                (HooInt64Array, LLVM_PTR)) \
            RUNTIME_FUNCTION(refcount, int64_t, LLVM_I64, \
        ...
        END_RUNTIME_OPERATORS \
    \
    DEFINE_RUNTIME_CLASS(DoubleArray, HooDoubleArray, isPointerTy) \
        BEGIN_RUNTIME_FUNCTIONS \
            /* Creation functions */ \
            RUNTIME_FUNCTION(new, HooDoubleArray, LLVM_PTR, \
                (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(from_buffer, HooDoubleArray, LLVM_PTR, \
                (const double*, LLVM_PTR), (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(repeat, HooDoubleArray, LLVM_PTR, \
                (double, LLVM_F64), (int64_t, LLVM_I64)) \
            \
            /* Basic operations */ \
            RUNTIME_FUNCTION(length, int64_t, LLVM_I64, \
                (HooDoubleArray, LLVM_PTR)) \
            RUNTIME_FUNCTION(get, double, LLVM_F64, \
                (HooDoubleArray, LLVM_PTR), (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(set, int64_t, LLVM_I64, \
                (HooDoubleArray, LLVM_PTR), (int64_t, LLVM_I64), (double, LLVM_F64)) \
            RUNTIME_FUNCTION(push, int64_t, LLVM_I64, \
                (HooDoubleArray, LLVM_PTR), (double, LLVM_F64)) \
            RUNTIME_FUNCTION(pop, double, LLVM_F64, \
                (HooDoubleArray, LLVM_PTR)) \
            RUNTIME_FUNCTION(clear, void, LLVM_VOID, \
                (HooDoubleArray, LLVM_PTR)) \
            RUNTIME_FUNCTION(concat, HooDoubleArray, LLVM_PTR, \
                (HooDoubleArray, LLVM_PTR), (HooDoubleArray, LLVM_PTR)) \
            RUNTIME_FUNCTION(slice, HooDoubleArray, LLVM_PTR, \
                (HooDoubleArray, LLVM_PTR), (int64_t, LLVM_I64), (int64_t, LLVM_I64)) \
            RUNTIME_FUNCTION(clone, HooDoubleArray, LLVM_PTR, \
                (HooDoubleArray, LLVM_PTR)) \
            \
            /* Reference counting */ \
            RUNTIME_FUNCTION(retain, HooDoubleArray, LLVM_PTR, \
                (HooDoubleArray, LLVM_PTR)) \
            RUNTIME_FUNCTION(release, void, LLVM_VOID, \
                (HooDoubleArray, LLVM_PTR)) \
            RUNTIME_FUNCTION(refcount, int64_t, LLVM_I64, \
